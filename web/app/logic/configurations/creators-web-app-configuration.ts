...
} from '~ims-app-base/logic/configurations/base-app-configuration';
import type { IAppManager } from '~ims-app-base/logic/managers/IAppManager';
import ProjectManager from '~ims-app-base/logic/managers/ProjectManager';

export default class CreatorsWebAppConfiguration extends BaseAppConfiguration {
  override name = 'creators-web';
  override appTitle = 'Creators';
  override isDesktop = false;
  ...
  override getProjectMenu(appManager: IAppManager): ProjectMenuItem[] {
    ...
    const ProjectTreePanel = defineAsyncComponent(
      () =>
        import(
          '~ims-app-base/components/GameDesign/ProjectTreePanel.vue'
        ),
    );
